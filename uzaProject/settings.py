"""
Django settings for uzaProject project.
...
SECRET_KEY = 'django-insecure-pjwiouqt0j+y4-c_1rnqn#qd2jvot+rwaqcp6u)01db9lbj+hh'
...
WSGI_APPLICATION = 'uzaProject.wsgi.application'
